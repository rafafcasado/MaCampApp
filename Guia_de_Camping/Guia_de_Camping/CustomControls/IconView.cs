...
namespace Aspbrasil.CustomControls
{
    public class IconView : View
    {
        ...
        public static readonly BindableProperty ForegroundProperty = BindableProperty.Create(nameof(Foreground), typeof(Color), typeof(IconView), Color.FromHex("6f6d6d"));
