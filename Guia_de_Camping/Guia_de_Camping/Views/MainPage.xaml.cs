...
namespace Aspbrasil.Views
{
    ...
    public partial class MainPage : TabbedPage
    {
        public MainPage(int selected = 1)
        {
            ...
            Children.Add(new CampingsPage() { IconImageSource = "icone_aba1.png" });
            ...
            Children.Add(new ListagemItensPage() { Title = "Favoritos", IconImageSource = "icone_aba3.png" });
            Children.Add(new ListagemItensPage("https://guiadecampings.homologacao.net/api/PostsAPI/GetPosts", "Eventos", TipoListagem.Noticias, "app-eventos") { Title = "Eventos", IconImageSource = "icone_aba4.png" });
